...
class Trainer:
    def __init__(self, args, train_loader, dev_loader, test_loader):
        ...
        if torch.cuda.device_count() > 1:
            ...
            self.model = torch.nn.DataParallel(self.model, device_ids=[int(i) for i in args.gpu_ids.split(",")])
    ...
    def get_metrics(self, outputs, targets):
        ...
        micro_f1 = f1_score(targets, outputs, average='micro',zero_division=0)
        macro_f1 = f1_score(targets, outputs, average='macro',zero_division=0)
